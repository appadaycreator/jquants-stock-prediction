...
class UnifiedSystem:
    ...
    def __init__(self, module_name: str = "UnifiedSystem", config_file: str = "config_unified.yaml"):
        """初期化"""
    ...
    def log_error(
        ...
        # エラーログの出力
        self.logger.error(f"❌ エラー #{self.error_count} [{category.value}]: {sanitized_context}")
    ...
    def handle_data_processing_error(
        ...
        self.log_error(error, error_context, ErrorCategory.DATA_PROCESSING_ERROR, additional_info)
