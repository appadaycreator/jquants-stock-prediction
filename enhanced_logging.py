...
class EnhancedLogger:
    ...
    def log_data_info(self, data_name: str, shape: tuple = None, dtype: str = None, **kwargs):
        """データ情報ログ"""
    ...
    def log_error_with_context(self, message: str, error: Exception = None, context: Dict[str, Any] = None):
        """コンテキスト付きエラーログ"""
...
def setup_enhanced_logging(logger_name: str = None, log_level: str = "INFO") -> EnhancedLogger:
    """強化されたログ設定を初期化"""
...
def get_enhanced_logger(logger_name: str = None, log_level: str = "INFO") -> logging.Logger:
    """強化されたロガーを取得"""
...
if __name__ == "__main__":
    ...
    structured_logger.log_structured("INFO", "構造化ログテスト", user_id=123, operation="test")
