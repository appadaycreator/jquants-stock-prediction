...
class IndividualStockConfigManager:
    ...
    def _create_config_from_data(self, symbol: str, data: Dict[str, Any]) -> None:
        ...
        try:
            ...
            # 投資スタイルとリスク許容度
            investment_style = InvestmentStyle(data.get('investment_style', 'medium_term'))
    ...
    def update_config(self, symbol: str, **kwargs) -> bool:
        ...
        for key, value in kwargs.items():
            if key not in ['technical_thresholds', 'risk_management'] and hasattr(config, key):
