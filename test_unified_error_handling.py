...
class TestUnifiedErrorHandlingSystem(unittest.TestCase):
    ...
    def test_error_statistics(self):
        ...
        self.assertEqual(stats['performance_metrics']['critical_errors'], 0)  # CRITICALは0個
    ...
    def test_error_context_manager(self):
        """エラーコンテキストマネージャーのテスト"""
        with self.assertRaises(ValueError):
            with error_context("テスト操作", ErrorCategory.SYSTEM, ErrorSeverity.MEDIUM) as handler:
    ...
    def test_recovery_strategies(self):
        ...
        self.error_handler.recovery_strategies[ErrorCategory.SYSTEM] = [test_recovery_strategy]
...
class TestErrorHandlingIntegration(unittest.TestCase):
    ...
    def test_system_integration(self):
        ...
        errors = [
            ...
            (ConnectionError("接続エラー"), ErrorCategory.NETWORK, ErrorSeverity.MEDIUM),
            (FileNotFoundError("ファイルエラー"), ErrorCategory.FILE, ErrorSeverity.LOW)
        ]
