              ...
              {categories.map((category) => {
                ...
                return (
                  <button
                    ...
                    data-help={`${category.label}に関する問題を表示します。該当する問題の症状と解決方法を確認できます。段階的な解決手順に従って、問題を効率的に解決できます。問題の重要度（軽微・中程度・重要・緊急）も表示され、優先順位を把握できます。`}
                  >
            ...
            {filteredItems.map((item) => (
              <div key={item.id} className="bg-white rounded-lg shadow">
                <button
                  ...
                  data-help={`${item.title}の詳細情報を${expandedItem === item.id ? '閉じます' : '開きます'}。症状と解決方法を確認できます。段階的な解決手順に従って、問題を効率的に解決できます。問題の重要度（${getSeverityLabel(item.severity)}）も表示され、優先順位を把握できます。`}
                >
                              ...
                              <div className="flex-1">
                                ...
                                {solution.action && (
                                  <button
                                    ...
                                    aria-label="解決手順を実行"
                                    data-help="この解決手順を実行します。該当するページに移動して問題を解決できます。自動的に適切な画面に遷移し、問題解決のための操作を開始できます。解決手順は段階的に設計されており、各ステップを順番に実行することで問題を効率的に解決できます。"
                                  >
          ...
          <div className="bg-blue-50 rounded-lg p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <Link
                ...
                data-help="使い方ガイドページに移動します。システムの詳細な使用方法、操作手順、機能説明を確認できます。初心者から上級者まで、段階的にシステムの機能を理解できるよう設計されています。機械学習モデルの仕組み、予測指標の読み方、J-Quants APIの活用方法など、投資判断に必要な知識を体系的に学習できます。"
              >
              ...
              <Link
                ...
                data-help="5分ルーティンページに移動します。正しい操作手順と効率的な投資判断フローを確認できます。初心者でも迷わずに投資判断を行えるよう設計された標準的な操作手順を学習できます。データ更新状況の確認、上位候補銘柄の分析、保有銘柄の提案、メモ記録まで一連の流れを効率的に実行できます。"
              >
