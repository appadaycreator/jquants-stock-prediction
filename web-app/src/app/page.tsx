          ...
          <div className="flex justify-between items-center py-6">
            ...
            <div className="flex items-center space-x-4">
              <button
                ...
                data-help="システムの状態とパフォーマンスを診断します。CPU使用率、メモリ使用量、接続状況、エラー状況、キャッシュ状態などを詳細に確認できます。問題が発生した際の最初の確認ポイントです。リアルタイムでシステムの健全性を監視し、パフォーマンスの最適化に役立ちます。診断結果に基づいてシステムの改善提案も表示されます。"
              >
              ...
              <Link
                ...
                data-help="今日の投資判断タスクを開始します。5分で完了する効率的な投資判断フローで、重要なアクションを素早く実行できます。データ更新状況の確認、上位候補銘柄の分析、保有銘柄の提案、メモ記録まで一連の流れを実行します。初心者でも迷わずに投資判断を行えるよう設計されており、毎日の投資活動を効率化できます。機械学習による推奨アクションとテクニカル分析を組み合わせた総合的な投資判断を提供します。"
              >
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              aria-label="今日のタスクを開始"
              data-help="今日の投資判断タスクを開始します。5分で完了する効率的な投資判断フローで、重要なアクションを素早く実行できます。データ更新状況の確認、上位候補銘柄の分析、保有銘柄の提案、メモ記録まで一連の流れを実行します。初心者でも迷わずに投資判断を行えるよう設計されており、毎日の投資活動を効率化できます。機械学習による推奨アクションとテクニカル分析を組み合わせた総合的な投資判断を提供します。投資の学習効果を高め、過去の判断を振り返って投資スキルの向上に役立てることができます。"
            >
            ...
            <Link
              ...
              data-help="詳細な分析結果とダッシュボードを表示します。機械学習モデルの比較、パフォーマンス指標、市場インサイトなど、深い分析機能を提供します。複数の予測モデルの精度比較、特徴量重要度分析、予測誤差の詳細分析、モデル性能の可視化など、高度な分析機能を利用できます。プロの投資家向けの詳細な分析ツールとして、投資判断の精度向上に役立ちます。インタラクティブなチャートとレポート機能で、投資戦略の検証と改善に活用できます。"
            >
        ...
        <div className="bg-white rounded-xl shadow-sm border p-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <Link
              ...
              data-help="今日の投資判断タスクを確認・実行できます。5分で完了する効率的な投資判断フローで、重要なアクションを素早く実行できます。データ更新状況の確認、上位候補銘柄の分析、保有銘柄の提案、メモ記録まで一連の流れを実行します。初心者でも迷わずに投資判断を行えるよう設計されており、毎日の投資活動を効率化できます。"
            >
            ...
            <Link
              ...
              data-help="詳細な分析結果とダッシュボードを表示します。機械学習モデルの比較、パフォーマンス指標、市場インサイトなど、深い分析機能を提供します。複数の予測モデルの精度比較、特徴量重要度分析、予測誤差の詳細分析、モデル性能の可視化など、高度な分析機能を利用できます。プロの投資家向けの詳細な分析ツールとして、投資判断の精度向上に役立ちます。"
            >
            ...
            <Link
              ...
              data-help="上場銘柄の一覧と検索・フィルタリング機能です。セクター別、市場別、価格帯別の詳細フィルタリングが可能で、投資対象銘柄を効率的に発見できます。機械学習による推奨銘柄やテクニカル分析結果も確認でき、投資判断の精度向上に役立ちます。CSVエクスポート機能で分析結果を外部ツールで活用できます。"
            >
            ...
            <Link
              ...
              data-help="リスク評価と損切りラインの管理を行います。ポートフォリオのリスク分析、ドローダウン監視、自動アラート機能で投資を安全にサポートします。VaR（バリューアットリスク）計算、ストレステスト、相関分析などの高度なリスク指標を提供し、投資戦略の安全性を向上させます。"
            >
            ...
            <Link
              ...
              className="flex items-center space-x-3 p-4 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors"
              aria-label="設定ページへ移動"
              data-help="システム設定と予測パラメータを変更します。予測期間、使用モデル、特徴量選択、J-Quants API設定などをカスタマイズできます。設定のエクスポート・インポート機能で、設定をバックアップしたり他の環境で再利用できます。設定の検証機能で、設定値の妥当性を確認できます。"
            >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-6">
              <Link href="/usage" className="text-sm text-gray-600 hover:text-gray-900 flex items-center space-x-1" aria-label="使い方ガイドを表示" data-help="システムの使い方と機能説明を確認できます。詳細な操作手順、機械学習モデルの仕組み、予測指標の読み方などを学習できます。初心者から上級者まで、段階的にシステムの機能を理解できるよう設計されています。FAQ、動画リンク、トラブルシューティング情報も含まれています。">
                <BookOpen className="h-4 w-4" />
                <span>使い方</span>
              </Link>
              <Link href="/troubleshooting" className="text-sm text-gray-600 hover:text-gray-900" aria-label="トラブルシューティングページを表示" data-help="よくある問題と解決方法を確認できます。データ表示、分析実行、接続エラーなどの問題を段階的に解決できます。問題のカテゴリ別に整理されており、症状と解決手順を詳細に確認できます。システムのパフォーマンス最適化のヒントも提供されます。">
                トラブルシューティング
              </Link>
            </div>
          </div>
