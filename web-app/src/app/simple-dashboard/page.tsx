          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button
                ...
                data-help="ダッシュボードのデータを最新に更新します。推奨アクション、損益状況、保有銘柄の情報を再取得します。市場の最新動向に基づいて投資判断に必要な情報を最新に保ちます。リアルタイムで投資状況を監視し、重要な投資判断に必要な最新情報を確認できます。市場の開場・閉場状況も同時に更新され、投資タイミングを把握できます。初心者向けの分かりやすい投資判断画面で、複雑な分析結果をシンプルに表示し、重要な投資判断に集中できるよう設計されています。"
              >
