      ...
      <div className="flex justify-between items-center bg-white rounded-lg shadow-sm p-4">
        ...
        <div className="flex space-x-2">
          <Button
            ...
            data-help="リスク管理設定パネルを開きます。リスク許容度、投資期間、セクター設定などをカスタマイズできます。個人の投資方針に合わせてシステムの動作を最適化し、より精度の高い投資判断を実現できます。投資戦略の個別化により、リスクとリターンのバランスを最適化できます。設定は自動的に保存され、次回アクセス時に復元されます。AI/ルールベースによる投資提案、LSTM深層学習による株価予測、リアルタイム損益計算など、包括的な投資管理機能を提供します。"
          >
          ...
          <Button
            ...
            data-help="最新のダッシュボードデータを取得します。損益状況、保有銘柄、投資推奨、市場概況などの情報を再取得します。リアルタイムで投資状況を監視し、重要な投資判断に必要な最新情報を確認できます。市場の急激な変動や重要な投資判断が必要な状況を継続的に監視できます。データの鮮度も同時に更新され、投資判断の信頼性を高めます。AI/ルールベースによる投資提案、LSTM深層学習による株価予測、リアルタイム損益計算など、包括的な投資管理機能を提供します。"
          >
          ...
          <Button
            ...
            data-help={autoRefresh ? "30秒ごとの自動更新を停止します。手動更新に切り替わります。バッテリー消費を抑えたい場合や、更新頻度を制御したい場合に使用します。システムリソースの節約にも役立ちます。長時間の監視を一時停止したい場合にも便利です。AI/ルールベースによる投資提案、LSTM深層学習による株価予測、リアルタイム損益計算など、包括的な投資管理機能を提供します。" : "30秒ごとに自動更新を開始します。リアルタイムで投資状況を監視できます。市場の急激な変動や重要な投資判断が必要な状況を継続的に監視できます。投資機会を見逃さないようサポートします。システムのパフォーマンス指標も自動的に更新されます。AI/ルールベースによる投資提案、LSTM深層学習による株価予測、リアルタイム損益計算など、包括的な投資管理機能を提供します。"}
          >
