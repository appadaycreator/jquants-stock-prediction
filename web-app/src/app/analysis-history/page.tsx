          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
            <div className="flex-1 relative">
              ...
              <input
                ...
                aria-label="分析履歴を検索"
                data-help="銘柄コードや銘柄名で分析履歴を検索できます。過去の分析結果から特定の銘柄の履歴を素早く見つけられます。分析日時、推奨アクション、信頼度、リスクレベルなどの詳細情報を確認できます。投資判断の精度向上のため、過去の分析結果を振り返って学習効果を高めることができます。リアルタイム検索で、入力と同時に結果が絞り込まれます。"
              />
            </div>
            ...
            <div className="flex items-center gap-2">
              <select
                ...
                data-help="分析履歴をリスクレベルでフィルタリングします。低リスク、中リスク、高リスクの分析結果を分類して表示できます。リスク許容度に応じて過去の分析結果を絞り込んで確認できます。投資戦略の検証やリスク管理の改善に役立ちます。リスクレベルは分析時の市場状況と銘柄の特性に基づいて自動的に設定されます。"
              >
              ...
              <button
                ...
                aria-label="分析履歴を全削除"
                data-help="すべての分析履歴を削除します。この操作は取り消せません。ローカルストレージから全ての履歴データが完全に削除されます。データをクリーンアップしたい場合や、プライバシーを重視する場合に使用します。システムのパフォーマンス向上やストレージ容量の節約にも役立ちます。削除前に重要な分析結果は別途バックアップすることを推奨します。"
              >
                ...
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <a
                      ...
                      data-help="この銘柄の詳細ページを新しいタブで開きます。チャート分析、テクニカル指標、機械学習予測結果を確認できます。過去の分析結果と現在の状況を比較して、投資判断の精度向上に活用できます。プロの投資家レベルの分析ツールで、投資戦略の検証と改善に役立ちます。インタラクティブなチャートで、ズーム、パン、指標の追加・削除が可能です。"
                    >
