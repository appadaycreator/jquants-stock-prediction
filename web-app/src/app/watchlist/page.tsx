      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <Button
            ...
            data-help="ウォッチリストのデータを最新に更新します。銘柄の現在価格、推奨アクション、信頼度、リスクレベル、目標価格などの情報を再取得します。市場の最新動向に基づいて監視対象銘柄の状況を確認できます。リアルタイムで価格変動を監視し、投資機会を見逃さないようにサポートします。更新により、アラート条件の再評価も行われます。投資判断の精度向上のため、常に最新の情報を提供し、重要な価格変動や投資推奨の変更をリアルタイムで監視できます。"
          >
          ...
          <CardContent className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <Button 
                ...
                data-help="上場銘柄の一覧ページに移動して銘柄を選択できます。セクター別、市場別、価格帯別の詳細フィルタリングが可能です。投資対象となる銘柄を効率的に発見し、ウォッチリストに追加できます。機械学習による推奨銘柄やテクニカル分析結果も確認でき、投資判断の精度向上に役立ちます。CSVエクスポート機能で分析結果を外部ツールで活用できます。リアルタイム価格データ、出来高情報、テクニカル指標、投資推奨ランキングなど、包括的な銘柄情報を提供します。投資戦略に応じた銘柄選別機能も利用できます。"
              >
                銘柄一覧を見る
              </Button>
            </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button
                      ...
                      data-help="この銘柄の詳細なチャートと分析を表示します。テクニカル指標、価格予測、機械学習分析結果を確認できます。移動平均線、RSI、MACD、ボリンジャーバンドなどの技術分析指標と、AIによる価格予測を詳細に分析できます。プロの投資家レベルの分析ツールで、投資判断の精度向上に役立ちます。インタラクティブなチャートで、ズーム、パン、指標の追加・削除が可能です。投資判断の信頼性を高めるため、推奨アクションの根拠となる分析結果を詳細に確認できます。"
                    >
                    ...
                    <Button
                      ...
                      data-help="みんかぶの詳細ページを新しいタブで開きます。投資家の意見、財務情報、ニュース、決算情報、業績予想などの詳細情報を確認できます。投資判断の参考となる外部情報を効率的に収集できます。ファンダメンタル分析の補完として、投資判断の精度向上に役立ちます。投資家コミュニティの意見や評価も確認でき、市場のセンチメントを把握できます。投資判断の信頼性を高めるため、複数の情報源から総合的な分析を行うことができます。"
                    >
                    ...
                    <Button
                      ...
                      data-help="この銘柄をウォッチリストから削除します。削除後は監視対象から外れ、アラートも停止されます。投資対象から除外する際や、監視を終了する際に使用します。削除した銘柄は後から再度追加できます。ウォッチリストを整理して、重要な銘柄に集中できるようサポートします。削除操作は確認なしで実行されるため、注意して使用してください。投資戦略の見直しや、ポートフォリオの最適化に伴う銘柄の整理に役立ちます。"
                    >
