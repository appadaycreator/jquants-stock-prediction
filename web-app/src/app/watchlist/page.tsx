      ...
      <div className="flex justify-between items-center">
        ...
        <div className="flex space-x-2">
          <Button
            ...
            data-help="ウォッチリストのデータを最新に更新します。銘柄の現在価格、推奨アクション、信頼度、リスクレベル、目標価格などの情報を再取得します。市場の最新動向に基づいて監視対象銘柄の状況を確認できます。リアルタイムで価格変動を監視し、投資機会を見逃さないようにサポートします。"
          >
          ...
          <CardContent className="flex items-center justify-center py-12">
            <div className="text-center">
              ...
              <Button 
                ...
                data-help="上場銘柄の一覧ページに移動して銘柄を選択できます。セクター別、市場別、価格帯別の詳細フィルタリングが可能です。投資対象となる銘柄を効率的に発見し、ウォッチリストに追加できます。機械学習による推奨銘柄やテクニカル分析結果も確認でき、投資判断の精度向上に役立ちます。"
              >
                銘柄一覧を見る
              </Button>
            </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    <Button
                      ...
                      data-help="この銘柄の詳細なチャートと分析を表示します。テクニカル指標、価格予測、機械学習分析結果を確認できます。移動平均線、RSI、MACD、ボリンジャーバンドなどの技術分析指標と、AIによる価格予測を詳細に分析できます。プロの投資家レベルの分析ツールで、投資判断の精度向上に役立ちます。"
                    >
                    ...
                    <Button
                      ...
                      data-help="みんかぶの詳細ページを新しいタブで開きます。投資家の意見、財務情報、ニュース、決算情報、業績予想などの詳細情報を確認できます。投資判断の参考となる外部情報を効率的に収集できます。ファンダメンタル分析の補完として、投資判断の精度向上に役立ちます。"
                    >
                    ...
                    <Button
                      ...
                      data-help="この銘柄をウォッチリストから削除します。削除後は監視対象から外れ、アラートも停止されます。投資対象から除外する際や、監視を終了する際に使用します。削除した銘柄は後から再度追加できます。ウォッチリストを整理して、重要な銘柄に集中できるようサポートします。"
                    >
