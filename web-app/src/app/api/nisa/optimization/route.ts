...
export async function GET(request: NextRequest) {
  try {
    // 実際の実装では、NISA統合管理システムから最適化提案を取得
      ...
      recommendations: [
        {
          ...
          title: "成長投資枠の最適化",
          description: "成長投資枠の効率的活用",
          priority: "HIGH",
          action: "成長投資枠に500,000円の投資を検討してください",
        },
        {
          type: "TAX_OPTIMIZATION",
          title: "税務最適化",
          description: "税務メリットの最大化",
          priority: "HIGH",
          action: "非課税枠を最大限活用してください",
        },
      ],
      priority_score: 85.0,
    };
    ...
    console.error("NISA optimization API error:", error);
    return NextResponse.json(
      {
        success: false,
        error: {
          code: "INTERNAL_ERROR",
          message: "最適化提案の取得に失敗しました",
