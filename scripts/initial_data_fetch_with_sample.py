...
class InitialDataFetcherWithSample:
    ...
    def __init__(self):
        ...
        self.sample_stocks = [
            ...
            {"Code": "6758", "CompanyName": "ソニーグループ", "Sector17Code": "エレクトロニクス"},
            {"Code": "9984", "CompanyName": "ソフトバンクグループ", "Sector17Code": "情報通信"},
            {"Code": "6861", "CompanyName": "キーエンス", "Sector17Code": "エレクトロニクス"},
            {"Code": "4063", "CompanyName": "信越化学工業", "Sector17Code": "化学"},
            {"Code": "8035", "CompanyName": "東京エレクトロン", "Sector17Code": "エレクトロニクス"},
            {"Code": "8306", "CompanyName": "三菱UFJフィナンシャル・グループ", "Sector17Code": "銀行"},
    ...
    def generate_sample_price_data(self, code: str, name: str, days: int = 30) -> List[Dict[str, Any]]:
        """サンプル価格データの生成"""
    ...
    def process_stock_data(self, max_stocks: int = 10) -> Dict[str, Any]:
        ...
        for i, stock in enumerate(selected_stocks):
            ...
            processed_data["stocks"][code] = {
                ...
                "prediction": {
                    "predicted_price": round(float(latest_data.get("Close", 0)) * random.uniform(0.95, 1.05), 2),
