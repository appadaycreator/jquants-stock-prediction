...
def test_jquants_api():
    ...
    headers = {"Content-Type": "application/json", "User-Agent": "jQuants-API-Test/1.0"}
    ...
    auth_data = {"mailaddress": test_email, "password": test_password}
        ...
        if response.status_code == 200:
            ...
            if refresh_token:
                ...
                if refresh_response.status_code == 200:
                    ...
                    print(
                        f"IDトークン取得成功: {json.dumps(refresh_result, indent=2, ensure_ascii=False)}"
                    )
