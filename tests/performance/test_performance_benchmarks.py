...
class TestPerformanceBenchmarks:
    ...
    def test_concurrent_processing_performance(self):
        ...
        batches = [large_data[i:i + batch_size] for i in range(0, len(large_data), batch_size)]
    ...
    def test_concurrent_user_simulation(self):
        ...
        assert max_processing_time < 1.0, f"同時ユーザー処理時間が長すぎます: {max_processing_time:.3f}秒"
