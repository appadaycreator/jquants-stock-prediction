...
class TestAutomatedSchedulerComprehensive:
    ...
    @patch("automated_scheduler.LoggingManager")
    @patch("automated_scheduler.ErrorHandler")
    def test_execute_routine_success(
        self, mock_error_handler, mock_logging, mock_config
    ):
        """ルーティン実行成功テスト"""
        # モック設定
    ...
    @patch("automated_scheduler.LoggingManager")
    @patch("automated_scheduler.ErrorHandler")
    def test_execute_routine_failure(
        self, mock_error_handler, mock_logging, mock_config
    ):
        """ルーティン実行失敗テスト"""
        # モック設定
    ...
    @patch("automated_scheduler.ErrorHandler")
    @patch("automated_scheduler.requests.post")
    def test_api_call_direct_result(
        self, mock_post, mock_error_handler, mock_logging, mock_config
    ):
        """直接結果返却API呼び出しテスト"""
        # モック設定
    ...
    def test_wait_for_job_completion_running(
    ...
    @patch("automated_scheduler.requests.get")
    @patch("automated_scheduler.time.sleep")
    def test_wait_for_job_completion_queued(
        self, mock_sleep, mock_get, mock_error_handler, mock_logging, mock_config
    ):
        """ジョブキュー中待機テスト"""
        # モック設定
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"status": "queued", "progress": 0}
        mock_get.return_value = mock_response
    ...
    @patch("automated_scheduler.LoggingManager")
    @patch("automated_scheduler.ErrorHandler")
    def test_send_notifications_mixed_enabled(
        self, mock_error_handler, mock_logging, mock_config
    ):
        """混在通知有効テスト"""
        # モック設定
    ...
    @patch("automated_scheduler.LoggingManager")
    @patch("automated_scheduler.ErrorHandler")
    def test_notification_content_success_detailed(
        self, mock_error_handler, mock_logging, mock_config
    ):
        """成功通知内容詳細テスト"""
        # モック設定
    ...
    @patch("automated_scheduler.LoggingManager")
    @patch("automated_scheduler.ErrorHandler")
    def test_notification_content_failure_detailed(
        self, mock_error_handler, mock_logging, mock_config
    ):
        """失敗通知内容詳細テスト"""
        # モック設定
    ...
    @patch("automated_scheduler.LoggingManager")
    @patch("automated_scheduler.ErrorHandler")
    def test_browser_notification_directory_creation(
        self, mock_error_handler, mock_logging, mock_config
    ):
        """ブラウザ通知ディレクトリ作成テスト"""
        # モック設定
    ...
    @patch("automated_scheduler.LoggingManager")
    @patch("automated_scheduler.ErrorHandler")
    def test_manual_execute_success(
        self, mock_error_handler, mock_logging, mock_config
    ):
        """手動実行成功テスト"""
        # モック設定
    ...
    @patch("automated_scheduler.LoggingManager")
    @patch("automated_scheduler.ErrorHandler")
    def test_manual_execute_failure(
        self, mock_error_handler, mock_logging, mock_config
    ):
        """手動実行失敗テスト"""
        # モック設定
