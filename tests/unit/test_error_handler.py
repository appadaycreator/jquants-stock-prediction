...
class TestErrorHandler:
    ...
    def test_log_error_with_additional_info(self):
        ...
        handler.log_error(error, "Test context", ErrorCategory.MODEL_ERROR, additional_info)
    ...
    def test_attempt_error_recovery_failure(self):
        ...
        # 復旧処理で例外を発生させる
        with patch.object(handler, '_attempt_error_recovery', side_effect=Exception("Recovery failed")):
