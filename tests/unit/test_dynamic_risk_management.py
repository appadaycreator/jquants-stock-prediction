...
from core.dynamic_risk_management import (
    DynamicRiskManager, RiskLevel, RiskMetrics, DynamicRiskAdjustment
)
...
class TestDynamicRiskManager(unittest.TestCase):
    ...
    def test_correlation_calculation(self):
        """相関計算テスト"""
        correlation = self.manager._calculate_correlation(self.stock_data, self.market_data)
    ...
    def test_dynamic_position_size_calculation(self):
        ...
        self.assertLessEqual(position_size, self.config["risk_limits"]["max_position_size"])
    ...
    def test_position_adjustment_decision(self):
        ...
        self.assertLess(adjustments["new_position_size"], high_risk_metrics.position_size)
    ...
    def test_optimal_position_size_calculation(self):
        ...
        self.assertLessEqual(optimal_size, self.config["risk_limits"]["max_position_size"])
