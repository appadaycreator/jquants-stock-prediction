...
class TestPredictionEngine:
    ...
    def test_detect_overfitting_error(self):
        ...
        with patch.object(engine, '_detect_overfitting', side_effect=Exception("Test error")):
    ...
    def test_run_stock_prediction_success(self, mock_read_csv):
        ...
        config = {
            "prediction": {
                "input_file": "test.csv",
                "features": ["SMA_5", "SMA_25", "SMA_50", "Close_lag_1", "Close_lag_5", "Close_lag_25"],
                "target": "Close",
                "test_size": 0.2,
                "random_state": 42,
                "model_selection": {
    ...
    def test_create_visualization_with_font_config(self):
        ...
        with patch('matplotlib.pyplot.figure'), \
             ...
             patch('matplotlib.pyplot.savefig'), \
             patch('matplotlib.pyplot.close'), \
             patch('builtins.__import__', side_effect=ImportError("No module named 'font_config'")):
    ...
    def test_create_visualization_font_import_error(self):
        ...
        with patch('matplotlib.pyplot.figure'), \
            ...
            engine._create_visualization(y_test, y_pred, "test_model", "test.png")
            mock_logger.log_warning.assert_called_with("日本語フォント設定をスキップします")
