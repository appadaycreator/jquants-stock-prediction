...
class TestOverfittingDetector:
    ...
    def test_detect_overfitting_medium_risk_threshold(self):
        """過学習検出テスト（中リスク - 閾値超過）"""
        result = self.detector.detect_overfitting(
            0.90, 0.88, 0.96, max_r2_threshold=0.95
        )
    ...
    def test_detect_overfitting_custom_threshold(self):
        """過学習検出テスト（カスタム閾値）"""
        result = self.detector.detect_overfitting(
            0.90, 0.88, 0.92, max_r2_threshold=0.90
        )
    ...
    def test_boundary_values(self):
        ...
        # 閾値ちょうど
        result = self.detector.detect_overfitting(
            0.90, 0.88, 0.95, max_r2_threshold=0.95
        )
        assert result["is_overfitting"] is False
    ...
    def test_multiple_detections(self):
        ...
        for i in range(3):
            result = self.detector.detect_overfitting(
                0.90 + i * 0.01, 0.88 + i * 0.01, 0.92 + i * 0.01
            )
    ...
    def test_custom_max_r2_threshold(self):
        ...
        # 閾値を0.8に設定
        result = self.detector.detect_overfitting(
            0.90, 0.88, 0.85, max_r2_threshold=0.8
        )
    ...
    def test_analyze_overfitting_trend_with_history(self):
        ...
        # 検出履歴を作成
        for i in range(5):
            self.detector.detect_overfitting(
                0.90 + i * 0.01, 0.88 + i * 0.01, 0.92 + i * 0.01
            )
    ...
    def test_get_overfitting_recommendations_high_risk(self):
        """過学習対策推奨事項テスト（高リスク）"""
        detection_result = {"risk_level": "高", "train_val_diff": 0.1}

        recommendations = self.detector.get_overfitting_recommendations(
            detection_result
        )
    ...
    def test_get_overfitting_recommendations_medium_risk(self):
        """過学習対策推奨事項テスト（中リスク）"""
        detection_result = {"risk_level": "中", "train_val_diff": 0.1}
    ...
    def test_get_overfitting_recommendations_low_risk(self):
        """過学習対策推奨事項テスト（低リスク）"""
        detection_result = {"risk_level": "低", "train_val_diff": 0.06}
    ...
    def test_get_overfitting_recommendations_normal(self):
        """過学習対策推奨事項テスト（正常）"""
        detection_result = {"risk_level": "低", "train_val_diff": 0.03}
