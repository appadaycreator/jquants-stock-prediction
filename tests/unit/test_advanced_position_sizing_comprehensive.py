...
class TestAdvancedPositionSizingComprehensive:
    ...
    def test_apply_portfolio_correlation_adjustment_error_handling(self, position_sizing):
    ...
    def test_calculate_position_size_comprehensive(self, position_sizing):
        ...
        # 基本フィールドの確認
        required_fields = [
            'position_size', 'base_size', 'risk_adjusted_size',
            'volatility_adjusted_size', 'correlation_adjusted_size',
            'portfolio_adjusted_size', 'confidence', 'volatility',
            'correlation', 'portfolio_correlation', 'risk_level',
            'position_value', 'position_percent', 'max_loss_amount',
            'risk_metrics'
        ]
