...
from core.nisa_tax_calculator import (
    NisaTaxCalculator, TaxCalculation, TaxOptimization
)
...
class TestNisaTaxCalculator:
    ...
    def test_calculate_tax_savings(self, tax_calculator, sample_quota_status, sample_portfolio):
        """税務計算テスト"""
        result = tax_calculator.calculate_tax_savings(sample_quota_status, sample_portfolio)
    ...
    def test_calculate_current_year_tax(self, tax_calculator, sample_quota_status, sample_portfolio):
        """現在年度税務計算テスト"""
        current_year = tax_calculator._calculate_current_year_tax(sample_quota_status, sample_portfolio)
    ...
    def test_calculate_next_year_tax(self, tax_calculator, sample_quota_status, sample_portfolio):
        """翌年度税務計算テスト"""
        next_year = tax_calculator._calculate_next_year_tax(sample_quota_status, sample_portfolio)
    ...
    def test_calculate_tax_savings_amount(self, tax_calculator, sample_quota_status, sample_portfolio):
        """税務節約額計算テスト"""
        tax_savings = tax_calculator._calculate_tax_savings(sample_quota_status, sample_portfolio)
    ...
    def test_calculate_total_tax_free_amount(self, tax_calculator, sample_quota_status):
        """総非課税枠額計算テスト"""
        total_amount = tax_calculator._calculate_total_tax_free_amount(sample_quota_status)
        
        assert total_amount == 1400000.0  # 1200000 + 200000
    
    def test_calculate_effective_tax_rate(self, tax_calculator, sample_quota_status, sample_portfolio):
        """実効税率計算テスト"""
        effective_rate = tax_calculator._calculate_effective_tax_rate(sample_quota_status, sample_portfolio)
        
        assert effective_rate > 0
        assert effective_rate <= tax_calculator.total_tax_rate
    
    def test_get_tax_optimization(self, tax_calculator, sample_quota_status, sample_portfolio):
        """税務最適化提案テスト"""
        optimization = tax_calculator.get_tax_optimization(sample_quota_status, sample_portfolio)
    ...
    def test_generate_tax_recommendations(self, tax_calculator, sample_quota_status, sample_portfolio):
        """税務推奨事項生成テスト"""
        recommendations = tax_calculator._generate_tax_recommendations(sample_quota_status, sample_portfolio)
    ...
    def test_calculate_potential_tax_savings(self, tax_calculator, sample_quota_status, sample_portfolio):
        """潜在税務節約額計算テスト"""
        potential_savings = tax_calculator._calculate_potential_tax_savings(sample_quota_status, sample_portfolio)
    ...
    def test_calculate_optimization_score(self, tax_calculator, sample_quota_status, sample_portfolio):
        """最適化スコア計算テスト"""
        score = tax_calculator._calculate_optimization_score(sample_quota_status, sample_portfolio)
    ...
    def test_calculate_tax_effectiveness(self, tax_calculator):
        ...
        effectiveness = tax_calculator._calculate_tax_effectiveness(annual_summary, quota_status)
    ...
    def test_generate_annual_recommendations(self, tax_calculator):
        ...
        recommendations = tax_calculator._generate_annual_recommendations(annual_summary, quota_status)
    ...
    def test_empty_data_handling(self, tax_calculator):
        ...
        result = tax_calculator.calculate_tax_savings(empty_quota_status, empty_portfolio)
    ...
    def test_error_handling(self, tax_calculator):
        ...
        result = tax_calculator.calculate_tax_savings(invalid_quota_status, invalid_portfolio)
    ...
    def test_optimization_score_edge_cases(self, tax_calculator):
        ...
        score = tax_calculator._calculate_optimization_score(high_utilization_status, high_diversification_portfolio)
    ...
    def test_recommendation_priority_logic(self, tax_calculator):
        ...
        recommendations = tax_calculator._generate_tax_recommendations(low_utilization_status, portfolio)
        
        # 低活用率の場合は推奨事項が生成されるはず
        growth_recs = [r for r in recommendations if 'GROWTH' in r.get('action', '')]
        accumulation_recs = [r for r in recommendations if 'ACCUMULATION' in r.get('action', '')]
