...
class TestSimplifiedRiskManager(unittest.TestCase):
    ...
    def test_calculate_simplified_risk_metrics(self):
        ...
        self.assertIn(
            result.risk_level,
            [
                SimplifiedRiskLevel.LOW,
                SimplifiedRiskLevel.MEDIUM,
                SimplifiedRiskLevel.HIGH,
            ],
        )
    ...
    def test_recommendation_assignment(self):
        ...
        # 中リスク
        recommendation = self.risk_manager._get_recommendation(
            SimplifiedRiskLevel.MEDIUM
        )
    ...
    def test_confidence_calculation(self):
        ...
        confidence = self.risk_manager._calculate_confidence(
    ...
    def test_error_handling(self):
        ...
        # 無効なポートフォリオデータでのテスト
        result = self.risk_manager.calculate_portfolio_risk_balance(None, 1000000.0)
        self.assertIsInstance(result, PortfolioRiskBalance)
...
class TestSimplifiedRiskAPI(unittest.TestCase):
    ...
    def test_get_simplified_risk_assessment_error(self):
        """簡素化リスク評価取得エラーテスト"""
        result = self.api.get_simplified_risk_assessment(None, 125.0, 100.0, 1000000.0)
