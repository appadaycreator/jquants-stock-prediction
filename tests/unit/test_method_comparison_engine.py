...
from core.method_comparison_engine import MethodComparisonEngine, ComparisonReport
...
class TestMethodComparisonEngine:
    ...
    def test_identify_trading_system_benefits(self):
        ...
        benefits = self.engine._identify_trading_system_benefits(
            excellent_trading_performance
        )
    ...
    def test_generate_charts_data(self):
        ...
        trading_performance = {
            ...
            "feature_importance": {"model1": {"feature1": 0.3, "feature2": 0.7}},
        }
