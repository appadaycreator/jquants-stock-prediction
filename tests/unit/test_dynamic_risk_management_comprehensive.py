...
from core.dynamic_risk_management import DynamicRiskManager, RiskLevel, RiskMetrics, DynamicRiskAdjustment
...
class TestDynamicRiskManagementComprehensive:
    ...
    def test_calculate_risk_metrics_normal(self, risk_manager, sample_stock_data, sample_market_data):
        """リスクメトリクス計算（正常ケース）"""
    ...
    def test_calculate_dynamic_risk_adjustment_normal(self, risk_manager, sample_stock_data, sample_market_data):
        """動的リスク調整計算（正常ケース）"""
    ...
    def test_should_adjust_position_market_conditions(self, risk_manager):
        ...
        result = risk_manager.should_adjust_position(current_metrics, None, market_conditions)
    ...
    def test_calculate_sharpe_ratio_normal(self, risk_manager, sample_stock_data, sample_market_data):
        """シャープレシオ計算（正常ケース）"""
        result = risk_manager._calculate_sharpe_ratio(sample_stock_data, sample_market_data)
    ...
    def test_calculate_beta_normal(self, risk_manager, sample_stock_data, sample_market_data):
        """ベータ計算（正常ケース）"""
    ...
    def test_calculate_correlation_normal(self, risk_manager, sample_stock_data, sample_market_data):
        """相関計算（正常ケース）"""
        result = risk_manager._calculate_correlation(sample_stock_data, sample_market_data)
    ...
    def test_calculate_time_decay_adjustment_with_history(self, risk_manager):
        ...
        risk_manager.risk_history = [
            RiskMetrics(var_95=0.02, var_99=0.05, max_drawdown=0.10, sharpe_ratio=1.0,
                       sortino_ratio=1.0, calmar_ratio=1.0, volatility=0.20, beta=1.0,
                       correlation=0.5, risk_level=RiskLevel.MEDIUM, position_size=0.1,
                       stop_loss=950.0, take_profit=1100.0),
            RiskMetrics(var_95=0.03, var_99=0.06, max_drawdown=0.12, sharpe_ratio=0.8,
                       sortino_ratio=0.8, calmar_ratio=0.8, volatility=0.25, beta=1.1,
                       correlation=0.6, risk_level=RiskLevel.MEDIUM, position_size=0.1,
                       stop_loss=950.0, take_profit=1100.0),
            RiskMetrics(var_95=0.04, var_99=0.07, max_drawdown=0.14, sharpe_ratio=0.6,
                       sortino_ratio=0.6, calmar_ratio=0.6, volatility=0.30, beta=1.2,
                       correlation=0.7, risk_level=RiskLevel.HIGH, position_size=0.1,
                       stop_loss=950.0, take_profit=1100.0)
        ]
    ...
    def test_calculate_kelly_fraction_normal(self, risk_manager):
        """ケリー基準計算（正常ケース）"""
        risk_metrics = RiskMetrics(
            var_95=0.02, var_99=0.05, max_drawdown=0.10, sharpe_ratio=1.0,
            sortino_ratio=1.0, calmar_ratio=1.0, volatility=0.20, beta=1.0,
            correlation=0.5, risk_level=RiskLevel.MEDIUM, position_size=0.1,
            stop_loss=950.0, take_profit=1100.0
        )
    ...
    def test_get_risk_statistics_with_history(self, risk_manager):
        ...
        risk_manager.risk_history = [
            ...
            RiskMetrics(var_95=0.03, var_99=0.06, max_drawdown=0.12, sharpe_ratio=0.8,
                       sortino_ratio=0.8, calmar_ratio=0.8, volatility=0.25, beta=1.1,
                       correlation=0.6, risk_level=RiskLevel.HIGH, position_size=0.1,
                       stop_loss=950.0, take_profit=1100.0)
        ]
