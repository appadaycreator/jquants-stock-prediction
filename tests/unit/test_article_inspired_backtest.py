...
class TestArticleInspiredBacktest:
    ...
    def test_run_article_method_backtest(self):
        ...
        prices = [{'close': price, 'volume': vol} for price, vol in zip(self.sample_data['close'], self.sample_data['volume'])]
    ...
    def test_run_enhanced_backtest(self):
        ...
        results = self.backtest.run_enhanced_backtest(predictions, prices, confidence_scores)
    ...
    def test_risk_management_integration(self):
        ...
        results_no_risk = self.backtest.run_enhanced_backtest(predictions, prices, confidence_scores)
    ...
    def test_position_sizing_integration(self):
        ...
        results_no_enhanced = self.backtest.run_enhanced_backtest(predictions, prices, confidence_scores)
    ...
    def test_edge_cases(self):
        ...
        try:
            ...
            prices = [{'close': price, 'volume': vol} for price, vol in zip(single_data['close'], single_data['volume'])]
            results = self.backtest.run_article_method_backtest(predictions, prices)
            assert 'total_return' in results
        except Exception:
        ...
        try:
            ...
            prices = [{'close': price, 'volume': vol} for price, vol in zip(same_data['close'], same_data['volume'])]
            results = self.backtest.run_article_method_backtest(predictions, prices)
            assert 'total_return' in results
        except Exception:
