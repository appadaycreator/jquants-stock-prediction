...
class TestDataValidatorEnhanced:
    ...
    def test_validate_volume_consistency_success(self):
        """ボリューム一貫性検証成功テスト"""
        validator = DataValidator()
        valid_data = pd.DataFrame({"Volume": [1000000, 1100000, 1200000]})
    ...
    def test_validate_volume_consistency_invalid(self):
        """ボリューム一貫性違反のテスト"""
        validator = DataValidator()
        invalid_data = pd.DataFrame({"Volume": [1000000, -100000, 1200000]})  # 負の値
    ...
    def test_validate_missing_values_success(self):
        """欠損値検証成功テスト"""
        validator = DataValidator()
        valid_data = pd.DataFrame({"Code": ["1234", "5678"], "Close": [100.0, 101.0]})
    ...
    def test_validate_missing_values_invalid(self):
        """欠損値検証失敗テスト"""
        validator = DataValidator()
        invalid_data = pd.DataFrame({"Code": ["1234", None], "Close": [100.0, np.nan]})
    ...
    def test_validate_outliers_success(self):
        """外れ値検証成功テスト"""
        validator = DataValidator()
        valid_data = pd.DataFrame({"Close": [100.0, 101.0, 102.0, 103.0, 104.0]})
    ...
    def test_validate_with_missing_config(self):
        """設定不足時のテスト"""
        validator = DataValidator()
        data = pd.DataFrame({"Code": ["1234"], "Close": [100.0]})
