...
class TestModelComparator:
    ...
    def test_compare_models_basic(self, sample_stock_data):
        ...
        if len(X) > 0:
            ...
            results = comparator.compare_models(models_config, X_train, X_test, y_train, y_test, feature_names)
    ...
    def test_compare_models_empty_config(self):
        ...
        results = comparator.compare_models({}, X_train, X_test, y_train, y_test, feature_names)
