...
class TestAdvancedQuantityCalculator:
    ...
    def test_calculate_optimal_quantity_with_existing_position(self):
        ...
        assert result.quantity <= (self.calculator.total_capital * self.calculator.max_position_size) / current_price
    ...
    def test_calculate_optimal_quantity_with_portfolio(self):
        ...
        result = self.calculator.calculate_optimal_quantity(
            symbol, current_price, target_price, confidence, volatility,
            None, portfolio_positions, market_condition
        )
    ...
    def test_apply_existing_position_adjustment(self):
        ...
        quantity = 1000
        existing_position = {
            'position_size_percentage': 0.08  # 8%
        }
    ...
    def test_apply_quantity_limits(self):
        ...
        max_allowed = int((self.calculator.total_capital * self.calculator.max_position_size) / current_price)
    ...
    def test_edge_cases(self):
        ...
        # 極端に高い信頼度
        result3 = self.calculator.calculate_optimal_quantity(
            'TEST', 100, 110, 1.0, 0.2
        )
        assert result3.quantity >= 0
        
        # 極端に低い信頼度
        result4 = self.calculator.calculate_optimal_quantity(
            'TEST', 100, 110, 0.0, 0.2
        )
