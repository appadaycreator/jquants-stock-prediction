...
class TestSharpeRatioOptimizer:
    ...
    def test_preprocess_portfolio_data(
        self, optimizer, sample_portfolio_data, sample_market_data
    ):
        """ポートフォリオデータ前処理テスト"""
        processed_data = optimizer._preprocess_portfolio_data(
            sample_portfolio_data, sample_market_data, None
        )
    ...
    def test_calculate_current_sharpe_ratio(
        self, optimizer, sample_portfolio_data, sample_market_data
    ):
        """現在のシャープレシオ計算テスト"""
        processed_data = optimizer._preprocess_portfolio_data(
    ...
    def test_optimize_equal_risk_contribution(
        self, optimizer, sample_portfolio_data, sample_market_data
    ):
        """等リスク寄与最適化テスト"""
        processed_data = optimizer._preprocess_portfolio_data(
    ...
    def test_calculate_black_litterman_returns(
        self, optimizer, sample_portfolio_data, sample_market_data
    ):
    ...
    def test_optimize_max_sharpe_with_returns(
        self, optimizer, sample_portfolio_data, sample_market_data
    ):
        ...
        result = optimizer._optimize_max_sharpe_with_returns(
            processed_data, expected_returns
        )
    ...
    def test_calculate_risk_metrics(
        ...
        risk_metrics = optimizer._calculate_risk_metrics(
            optimization_result, processed_data
        )
    ...
    def test_calculate_performance_metrics(
        ...
        performance_metrics = optimizer._calculate_performance_metrics(
            optimization_result, processed_data
        )
    ...
    def test_optimize_sharpe_ratio_integration(
        self, optimizer, sample_portfolio_data, sample_market_data
    ):
        """シャープレシオ最適化統合テスト"""
