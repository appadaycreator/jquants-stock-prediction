...
from enhanced_config_loader import EnhancedConfigLoader, get_config_loader, get_config, validate_environment
...
class TestEnhancedConfigLoader:
    ...
    def test_get_config_function(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            with patch('enhanced_config_loader.EnhancedConfigLoader') as mock_loader_class:
...
class TestConfigValidator:
    ...
    def test_validate_api_config(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            # エラーが検出されることを確認
            error_results = [r for r in validator.results if r.level.value == "error"]
            warning_results = [r for r in validator.results if r.level.value == "warning"]
