...
class TestImprovedTradingSystem:
    ...
    def test_create_features(self):
        ...
        expected_features = [
            ...
            'MA5_Deviation', 'MA20_Deviation', 'MA50_Deviation',
            'Volatility_5', 'Volatility_20', 'Volatility_50',
            'Volume_Change', 'Volume_MA_5', 'Volume_MA_20', 'Volume_Ratio',
            'RSI', 'MACD', 'MACD_Signal', 'MACD_Histogram',
            'BB_Upper', 'BB_Lower', 'BB_Middle', 'BB_Width', 'BB_Position',
            'ATR', 'Stoch_K', 'Stoch_D', 'Williams_R', 'CCI', 'ADX',
    ...
    def test_calculate_risk_metrics(self):
        """リスク指標計算のテスト"""
        returns = pd.Series([0.01, -0.02, 0.03, -0.01, 0.02, -0.03, 0.01, 0.02, -0.01, 0.03])
