...
class TestAdvancedRiskMetricsEnhanced(unittest.TestCase):
    ...
    def test_calculate_max_drawdown_peak_to_trough_success(self):
        ...
        max_dd = self.risk_metrics._calculate_max_drawdown_peak_to_trough(
            cumulative_returns
        )
    ...
    def test_calculate_max_drawdown_peak_to_trough_insufficient_data(self):
        ...
        with patch.object(self.risk_metrics.logger, "warning") as mock_warning:
            result = self.risk_metrics._calculate_max_drawdown_peak_to_trough(
                cumulative_returns
            )
    ...
    def test_calculate_max_drawdown_peak_to_trough_exception(self):
        ...
        with patch(
            "numpy.maximum.accumulate", side_effect=Exception("Accumulate error")
        ):
            with patch.object(self.risk_metrics.logger, "error") as mock_error:
                result = self.risk_metrics._calculate_max_drawdown_peak_to_trough(
                    cumulative_returns
    ...
    def test_calculate_max_drawdown_rolling_insufficient_data(self):
        ...
        with patch.object(self.risk_metrics.logger, "warning") as mock_warning:
            result = self.risk_metrics._calculate_max_drawdown_rolling(
                cumulative_returns
            )
    ...
    def test_calculate_information_ratio_success(self):
        ...
        info_ratio = self.risk_metrics._calculate_information_ratio(
    ...
    def test_calculate_information_ratio_insufficient_data(self):
        ...
        with patch.object(self.risk_metrics.logger, "warning") as mock_warning:
            result = self.risk_metrics._calculate_information_ratio(
                returns, benchmark_returns
            )
    ...
    def test_calculate_treynor_ratio_success(self):
        ...
        treynor = self.risk_metrics._calculate_treynor_ratio(
    ...
    def test_calculate_treynor_ratio_insufficient_data(self):
        ...
        with patch.object(self.risk_metrics.logger, "warning") as mock_warning:
            result = self.risk_metrics._calculate_treynor_ratio(
    ...
    def test_calculate_jensen_alpha_success(self):
        ...
        alpha = self.risk_metrics._calculate_jensen_alpha(
            returns, benchmark_returns, risk_free_rate
        )
    ...
    def test_calculate_jensen_alpha_insufficient_data(self):
        ...
        with patch.object(self.risk_metrics.logger, "warning") as mock_warning:
            result = self.risk_metrics._calculate_jensen_alpha(
                returns, benchmark_returns, 0.02
            )
    ...
    def test_calculate_beta_success(self):
        ...
        benchmark_returns = pd.Series(
            np.random.normal(0.0008, 0.015, 1000), index=dates
        )
    ...
    def test_calculate_correlation_success(self):
        ...
        correlation = self.risk_metrics._calculate_correlation(
            returns, benchmark_returns
        )
    ...
    def test_calculate_correlation_insufficient_data(self):
        ...
        with patch.object(self.risk_metrics.logger, "warning") as mock_warning:
            result = self.risk_metrics._calculate_correlation(
                returns, benchmark_returns
            )
    ...
    def test_calculate_comprehensive_metrics_success(self):
        ...
        stock_data = pd.DataFrame(
            {"close": np.random.normal(100, 5, 1000).cumsum() + 10000}, index=dates
        )

        market_data = pd.DataFrame(
            {"close": np.random.normal(100, 3, 1000).cumsum() + 10000}, index=dates
        )

        benchmark_data = pd.DataFrame(
            {"close": np.random.normal(100, 2, 1000).cumsum() + 10000}, index=dates
        )
    ...
    def test_calculate_comprehensive_metrics_exception(self):
        ...
        dates = pd.date_range("2023-01-01", periods=100, freq="D")
        stock_data = pd.DataFrame(
            {"close": np.random.normal(100, 5, 100).cumsum() + 10000}, index=dates
        )

        market_data = pd.DataFrame(
            {"close": np.random.normal(100, 3, 100).cumsum() + 10000}, index=dates
        )

        with patch.object(
            self.risk_metrics, "_calculate_var", side_effect=Exception("Var error")
        ):
            with patch.object(self.risk_metrics.logger, "error") as mock_error:
                result = self.risk_metrics.calculate_comprehensive_risk_metrics(
    ...
    def test_get_risk_summary_exception(self):
        ...
        with patch.object(
            ...
            side_effect=Exception("Risk level error"),
        ):
            with patch.object(self.risk_metrics.logger, "error") as mock_error:
