...
from core.realtime_risk_monitor import (
    RealtimeRiskMonitor, AlertLevel, RiskEvent, RiskAlert, RiskSnapshot
)
...
class TestRealtimeRiskMonitor(unittest.TestCase):
    ...
    def test_initialization(self):
        ...
        self.assertEqual(self.monitor.config["risk_thresholds"]["var_95_critical"], 0.05)
    ...
    def test_recommendation_generation(self):
        ...
        # 推奨事項生成
        recommendations = self.monitor._generate_recommendations(high_risk_snapshot, alerts)
