...
class TestArticleMethodAnalyzer:
    ...
    def test_run_article_backtest(self):
        """記事の手法バックテストのテスト"""
        result = self.analyzer._run_article_backtest(self.sample_data, Mock(), ['Price_Change'])
...
class TestImprovedMethodAnalyzer:
    ...
    def test_calculate_improved_accuracy(self):
        ...
        accuracy = self.analyzer._calculate_improved_accuracy(y_true, y_pred, confidence_scores)
        assert 0 <= accuracy <= 1
    ...
    def test_run_improved_backtest(self):
        ...
        result = self.analyzer._run_improved_backtest(self.sample_data, models, features, confidence_scores)
...
class TestMethodComparison:
    ...
    def test_calculate_improvement_metrics(self):
        ...
        metrics = self.comparison._calculate_improvement_metrics(article_result, improved_result)
