...
class TestDifferentialUpdaterCoverage:
    ...
    def test_error_handling_in_batch_update(self):
        """バッチ更新時のエラーハンドリングテスト"""
        with patch('core.differential_updater.DifferentialUpdater.update_stock_data', side_effect=Exception("Update failed")):
    ...
    def test_create_success_result(self):
        ...
        diff_result = DiffResult(added_count=5, updated_count=2, removed_count=1, unchanged_count=0, processing_time=0.1, data_hash="test", is_significant_change=True)
    ...
    def test_create_error_result(self):
        ...
        result = self.updater._create_error_result("1234", UpdateStatus.FAILED, "Test error")
        assert isinstance(result, dict)
