...
class TestAutomatedScheduler:
    ...
    @patch('automated_scheduler.LoggingManager')
    @patch('automated_scheduler.ErrorHandler')
    def test_scheduler_config_loading(self, mock_error_handler, mock_logging, mock_config):
        """スケジューラー設定読み込みテスト"""
        # モック設定
        mock_config_instance = Mock()
        mock_config_instance.get_config.return_value = {
    ...
    @patch('automated_scheduler.LoggingManager')
    @patch('automated_scheduler.ErrorHandler')
    def test_notification_config_loading(self, mock_error_handler, mock_logging, mock_config):
        """通知設定読み込みテスト"""
        # モック設定
        mock_config_instance = Mock()
        mock_config_instance.get_config.return_value = {
        ...
        assert scheduler.notification_config.slack_webhook_url == "https://test.slack.com/webhook"
    ...
    def test_stop_scheduler(self, mock_sleep, mock_error_handler, mock_logging, mock_config):
        """スケジューラー停止テスト"""
        # モック設定
        mock_config_instance = Mock()
        mock_config_instance.get_config.return_value = {
    ...
    def test_api_call_success(self, mock_post, mock_error_handler, mock_logging, mock_config):
        """API呼び出し成功テスト"""
        # モック設定
        mock_config_instance = Mock()
        mock_config_instance.get_config.return_value = {
    ...
    @patch('automated_scheduler.ErrorHandler')
    @patch('automated_scheduler.requests.post')
    def test_api_call_failure(self, mock_post, mock_error_handler, mock_logging, mock_config):
        """API呼び出し失敗テスト"""
        # モック設定
        mock_config_instance = Mock()
        mock_config_instance.get_config.return_value = {
    ...
    @patch('automated_scheduler.ErrorHandler')
    @patch('automated_scheduler.requests.post')
    def test_api_call_timeout(self, mock_post, mock_error_handler, mock_logging, mock_config):
        """API呼び出しタイムアウトテスト"""
        # モック設定
        mock_config_instance = Mock()
        mock_config_instance.get_config.return_value = {
    ...
    @patch('automated_scheduler.LoggingManager')
    @patch('automated_scheduler.ErrorHandler')
    def test_notification_content_preparation(self, mock_error_handler, mock_logging, mock_config):
        """通知内容準備テスト"""
        # モック設定
        mock_config_instance = Mock()
        mock_config_instance.get_config.return_value = {
    ...
    def test_email_notification_success(self, mock_smtp, mock_error_handler, mock_logging, mock_config):
        """メール通知成功テスト"""
        # モック設定
        mock_config_instance = Mock()
        mock_config_instance.get_config.return_value = {
    ...
    @patch('automated_scheduler.ErrorHandler')
    @patch('automated_scheduler.requests.post')
    def test_slack_notification_success(self, mock_post, mock_error_handler, mock_logging, mock_config):
        """Slack通知成功テスト"""
        # モック設定
        mock_config_instance = Mock()
        mock_config_instance.get_config.return_value = {
