...
class TestNisaIntegration:
    ...
    def test_complete_nisa_workflow(self, integrated_manager):
        ...
        assert updated_dashboard.quota_status['growth_investment']['used_amount'] == 250000.0
        assert updated_dashboard.quota_status['accumulation_investment']['used_amount'] == 120000.0
