...
# モジュールの読み込み
nisa_quota_manager = load_module_from_path('nisa_quota_manager', 'core/nisa_quota_manager.py')
nisa_tax_calculator = load_module_from_path('nisa_tax_calculator', 'core/nisa_tax_calculator.py')
nisa_optimization_system = load_module_from_path('nisa_optimization_system', 'core/nisa_optimization_system.py')
...
class TestNisaQuotaManager(unittest.TestCase):
    ...
    def setUp(self):
        """テスト前の準備"""
        self.config = {
            'nisa_data_file': 'test_data/nisa_test.json'
        }
...
class TestNisaOptimizationEngine(unittest.TestCase):
    ...
    def test_get_optimization_recommendations(self):
        ...
        quota_status = NisaQuotaStatus(
            ...
            accumulation_investment={'utilization_rate': 50.0, 'available_amount': 200000},
            quota_reuse={},
            optimization={},
            last_updated=datetime.now().isoformat()
        )
        
        recommendations = self.optimization_engine.get_optimization_recommendations(quota_status)
...
class TestNisaTaxCalculator(unittest.TestCase):
    ...
    def test_calculate_tax_savings(self):
        ...
        tax_calculation = self.tax_calculator.calculate_tax_savings(quota_status, portfolio)
    ...
    def test_calculate_optimization_metrics(self):
        ...
        metrics = self.tax_calculator._calculate_optimization_metrics(quota_status, portfolio)
...
class TestNisaOptimizationSystem(unittest.TestCase):
    ...
    def test_generate_optimization_report(self):
        ...
        report = self.optimization_system.generate_optimization_report(quota_status, portfolio)
    ...
    def test_calculate_current_score(self):
        ...
        score = self.optimization_system._calculate_current_score(quota_status, portfolio)
    ...
    def test_generate_recommendations(self):
        ...
        recommendations = self.optimization_system._generate_recommendations(quota_status, portfolio)
    ...
    def test_generate_ai_strategies(self):
        ...
        strategies = self.optimization_system._generate_ai_strategies(quota_status, portfolio)
    ...
    def test_calculate_tax_optimization(self):
        ...
        tax_optimization = self.optimization_system._calculate_tax_optimization(quota_status, portfolio)
    ...
    def test_create_implementation_plan(self):
        ...
        plan = self.optimization_system._create_implementation_plan(recommendations, ai_strategies)
...
class TestIntegration(unittest.TestCase):
    ...
    def setUp(self):
        """テスト前の準備"""
        self.config = {
            'nisa_data_file': 'test_data/nisa_integration_test.json'
        }
        self.quota_manager = NisaQuotaManager(self.config)
        self.tax_calculator = NisaTaxCalculator(self.config)
        self.optimization_system = NisaOptimizationSystem(self.config)
