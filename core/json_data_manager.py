...
class JSONDataManager:
    ...
    def save_stock_data(self, symbol: str, data: List[Dict[str, Any]], 
                       source: str = "jquants_api") -> bool:
        """
        株価データの保存
        ...
        try:
            ...
            # 差分の計算
            diff_result = self._calculate_diff(existing_data.get(symbol, []), normalized_data)
    ...
    def _calculate_diff(self, old_data: List[Dict[str, Any]], 
    ...
    def get_incremental_data(self, symbol: str, last_update: Optional[str] = None) -> Dict[str, Any]:
        """
        差分データの取得
        ...
        try:
            ...
            for diff_entry in relevant_diffs:
                ...
                incremental_data.extend([item['new'] for item in diff.get('updated', [])])
    ...
    def get_diff_log(self, symbol: Optional[str] = None, limit: int = 100) -> List[Dict[str, Any]]:
        """
        差分ログの取得
