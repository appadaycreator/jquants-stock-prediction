...
class AdvancedQuantityCalculator:
    ...
    def _calculate_sector_correlation(
        ...
        try:
            ...
            if sector1 == sector2:
                return 0.8
            elif sector1 in ['technology', 'automotive'] and sector2 in ['technology', 'automotive']:
                return 0.6
            else:
                return 0.3
    ...
    def calculate_portfolio_risk(
        ...
        try:
            ...
            return {
                ...
                'risk_concentration': max_single_position_risk / total_risk if total_risk > 0 else 0
            }
