...
class MethodComparisonEngine:
    ...
    def run_comprehensive_comparison(self, data: pd.DataFrame) -> ComparisonReport:
        ...
        try:
            ...
            charts_data = self._generate_charts_data(
                data, article_result, improved_result, trading_performance
            )
    ...
    def _perform_detailed_comparison(
        self, article_result, improved_result, trading_performance
    ) -> Dict:
        """詳細比較の実行"""
        try:
            # 基本指標の比較
            ...
            # 取引システムとの比較
            trading_comparison = {
                "trading_system_return": trading_performance["backtest_result"][
                    "total_return"
                ],
                "trading_system_sharpe": trading_performance["backtest_result"][
                    "sharpe_ratio"
                ],
                "trading_system_drawdown": trading_performance["backtest_result"][
                    "max_drawdown"
                ],
                "trading_system_trades": trading_performance["backtest_result"][
                    "total_trades"
                ],
                "trading_system_win_rate": trading_performance["backtest_result"][
                    "win_rate"
                ],
            }
            ...
            # 改善効果の計算
            improvement_metrics = {
                "return_improvement_vs_article": improved_result.total_return
                - article_result.total_return,
                "return_improvement_vs_trading": trading_performance["backtest_result"][
                    "total_return"
                ]
                - article_result.total_return,
                "accuracy_improvement": improved_result.accuracy
                - article_result.accuracy,
                "risk_reduction": article_result.max_drawdown
                - improved_result.max_drawdown,
            ...
            return {
                ...
                "detailed_analysis": {
                    "article_method_issues": self._identify_article_method_issues(
                        article_result
                    ),
                    "improved_method_advantages": self._identify_improved_method_advantages(
                        improved_result
                    ),
                    "trading_system_benefits": self._identify_trading_system_benefits(
                        trading_performance
                    ),
                },
            }
    ...
    def _generate_charts_data(
        self, data: pd.DataFrame, article_result, improved_result, trading_performance
    ) -> Dict:
        """チャートデータの生成"""
        try:
            # エクイティカーブのデータ
            equity_curves = {
                ...
                "trading_system": trading_performance["backtest_result"][
                    "equity_curve"
                ],
            }
            ...
            return_distributions = {
                "article_method": self._calculate_return_distribution(
                    equity_curves["article_method"]
                ),
                "improved_method": self._calculate_return_distribution(
                    equity_curves["improved_method"]
                ),
                "trading_system": self._calculate_return_distribution(
                    equity_curves["trading_system"]
                ),
            }
            ...
            risk_metrics_comparison = {
                ...
                "trading_system": {
                    "max_drawdown": trading_performance["backtest_result"][
                        "max_drawdown"
                    ],
                    "sharpe_ratio": trading_performance["backtest_result"][
                        "sharpe_ratio"
                    ],
                    "total_return": trading_performance["backtest_result"][
                        "total_return"
                    ],
                },
            }
