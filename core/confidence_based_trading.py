...
class ConfidenceBasedTrading:
    ...
    def calculate_confidence(
        self, prediction: float, market_data: Dict[str, Any]
    ) -> float:
        """
        予測の信頼度を計算
    ...
    def _calculate_position_size(self, confidence: float, risk_level: str) -> float:
        ...
        try:
            ...
            # リスクレベルによる調整
            risk_multiplier = {"LOW": 1.0, "MEDIUM": 0.7, "HIGH": 0.3}.get(
                risk_level, 0.3
            )
    ...
    def execute_trade(
        self, trade_decision: Dict[str, Any], market_data: Dict[str, Any]
    ) -> Dict[str, Any]:
        """取引の実行"""
        try:
    ...
    def get_performance_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            avg_confidence = np.mean(
                [trade["confidence"] for trade in self.trade_history]
            )
