...
class SimplifiedRiskManager:
    ...
    def calculate_portfolio_risk_balance(
        self, portfolio_data: Dict[str, Dict[str, Any]], account_balance: float
                    ...
                    alerts.append(
                        {
                            ...
                            "severity": "HIGH",
                            "max_loss_amount": risk_metrics.max_loss_amount,
                            "loss_ratio": risk_metrics.max_loss_amount
                            / account_balance,
                            "color_code": risk_metrics.color_code,
                        }
                    )
    ...
    def get_visual_risk_display_data(
        self, portfolio_data: Dict[str, Dict[str, Any]]
    ) -> Dict[str, Any]:
        """視覚的リスク表示データ取得"""
        try:
            # ポートフォリオリスクバランス計算
            portfolio_balance = self.calculate_portfolio_risk_balance(
    ...
    def _calculate_max_loss_amount(
        ...
        max_loss_limit = (
            account_balance
            * self.config["max_loss_calculation"]["position_size_factor"]
        )
    ...
    def get_risk_statistics(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "risk_level_distribution": {
                level: risk_levels.count(level) for level in ["low", "medium", "high"]
            },
        }
