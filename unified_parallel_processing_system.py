    ...
    def get_system_stats(self) -> Dict[str, Any]:
        ...
        with self.lock:
            ...
            stats = {
                ...
                "avg_execution_time": self.total_execution_time / max(1, self.total_tasks_executed),
...
def parallel_optimized_decorator(task_type: str = "mixed", priority: int = 1):
    ...
    def decorator(func):
        ...
        def wrapper(*args, **kwargs):
            system = get_unified_system()
            return system.execute_parallel([lambda: func(*args, **kwargs)], task_type, priority=priority)[0]
        return wrapper
    return decorator
